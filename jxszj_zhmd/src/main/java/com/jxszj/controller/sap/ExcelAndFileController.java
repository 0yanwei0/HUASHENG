...
@Controller
public class ExcelAndFileController {
	...
	public void downloadImages(HttpServletRequest request, HttpServletResponse response, String imageName) {
		BufferedOutputStream out=null;
		try {
			//正式环境使用  /root/opt/apache-tomcat-7.0.90/webapps/hs_reportform/WEB-INF/images/hslogo.jpg
			String path = "/root/images/"+imageName;
