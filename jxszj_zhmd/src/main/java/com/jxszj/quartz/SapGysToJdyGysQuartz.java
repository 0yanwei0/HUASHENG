...
public class SapGysToJdyGysQuartz {
	...
	String appId1 = "5cc110c3b3c41744aaa12b2e";
	String entryId1 = "617b69806e29ec000795c95e";
	String apiKey1 = "uWEAujuxvzv5fMVifOvMRzlIJcPLgYkv";
	JDYAPIUtils api1 = new JDYAPIUtils(appId1, entryId1, apiKey1);
	...
	public void gys1(){
		...
		HttpGet httpGet = new HttpGet("https://my300201-api.saps4hanacloud.cn/sap/opu/odata/sap/YY1_SUPPLIERLISTAPI_CDS/YY1_SupplierListAPI?$filter=CompanyCode%20eq%20'C001'%20or%20CompanyCode%20eq%20'C002'");
		CloseableHttpResponse response = null;
		List<Map<String, Object>> list=api1.getAllFormData(null, null);
		for (int i = 0; i < list.size(); i++) {
			api1.deleteData(list.get(i).get("_id").toString());
		}
		try {
			...
			if(response.getStatusLine().getStatusCode()==200){
				...
				for (int i = 0; i < array.size(); i++) {
					if("BP06".equals(array.getJSONObject(i).getString("BusinessPartnerGrouping"))){
						createData1(array.getJSONObject(i));
					}
				}
			}else{
	...
	public void createData1(JSONObject json){
		try {
			Map<String, Object> rawData = new HashMap<String, Object>();
			Map<String, Object> m3 = new HashMap<String, Object>();
			m3.put("value", json.getString("CompanyCode")+json.getString("Supplier"));
			rawData.put("_widget_1635477888117", m3);// 唯一码
			Map<String, Object> m4 = new HashMap<String, Object>();
			m4.put("value", json.get("Supplier"));
			rawData.put("_widget_1635477888120", m4);// 供应商编码
			Map<String, Object> m5 = new HashMap<String, Object>();
			m5.put("value", json.get("SupplierName"));
			rawData.put("_widget_1635477888121", m5);// 供应商名称
			Map<String, Object> m10 = new HashMap<String, Object>();
			m10.put("value", json.get("BusinessPartnerGrouping"));
			rawData.put("_widget_1635477888119", m10);// 分组
			Map<String, Object> m11 = new HashMap<String, Object>();
			m11.put("value", json.get("CompanyCode"));
			rawData.put("_widget_1635477888118", m11);// 公司代码
			api1.createForData(rawData);
		} catch (Exception e) {
			e.printStackTrace();
			ExceptionRobot.robotSapMessage("SAP同步供应商","同步供应商"+json.getString("Supplier")+"失败");
		}
