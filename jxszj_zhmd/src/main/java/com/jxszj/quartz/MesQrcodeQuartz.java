...
public class MesQrcodeQuartz {
	...
	public void execute(){
		...
		try {
	        ...
	        //查询出交货周期表所有的生产订单，并去重
	        JSONArray array=getJSONArray("https://my300201-api.saps4hanacloud.cn/sap/opu/odata/sap/YY1_MANUFACORDERAPI_CDS/YY1_ManufacOrderAPI?$filter=MfgOrderActualReleaseDate%20eq%20datetime'"+DateUtils.getNowDateToString()+"T00:00:00'");
