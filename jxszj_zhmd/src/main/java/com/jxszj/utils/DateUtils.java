...
public class DateUtils {
	...
	public static String FORMAT_STRING2 = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";
	...
	public static String FORMAT_STRING_MINUTE2 = "M月dd日";
	...
	public static String getOneMonthBefore(){
		...
		ca.set(Calendar.DATE, ca.getActualMinimum(Calendar.DATE));
		Date lastMonth = ca.getTime(); //结果
		SimpleDateFormat sdf = new SimpleDateFormat(FORMAT_STRING1_MINUTE);
	    String str=sdf.format(lastMonth);
	    return str;
	}
	 ...
	 *</pre>
	 */
	public static String getLastDay(String strDate,String fmt){
		String str="";
		try {
...
//	  
	 ...
	 */
		 ...
		 *<pre>
		 *<b>Description:</b> 
		 *    将yyyy-MM-dd格式转换成指定格式
		 *<b>Author:</b> yanwei
		 *<b>Date:</b> 2021年8月31日 上午11:17:09
		 *@param strDate
		 *@param format
		 *@return
		 *@throws ParseException
		 *</pre>
		 */
		public static String getDateStringToStringFormat1(String strDate,String format){
			String str="";
			try {
				 SimpleDateFormat sdf = new SimpleDateFormat ("yyyy-MM-dd");
				 Date date =  sdf.parse(strDate);
		 ...
		 *</pre>
		 */
		public static String getDateStrToString(String strDate){
			String str="";
			try {
				 SimpleDateFormat sdf = new SimpleDateFormat ("yyyy-MM");
				 Date date =  sdf.parse(strDate);
				 SimpleDateFormat sdf1 = new SimpleDateFormat(FORMAT_1_STRING);
				 str=sdf1.format(date);
			} catch (Exception e) {
				e.printStackTrace();
			}
		 ...
		 *</pre>
		 */
		public static String getDateStrToString1(String strDate){
			String str="";
			try {
		 ...
		 *</pre>
		 */
		public static String getDateStrToString2(String strDate,String format1,String format2){
			String str="";
			try {
		 ...
		 *</pre>
		 */
		public static String getBeforeTwo(String format){
			Calendar calendar = Calendar.getInstance();
		...
		public static String getBeforeMonth(){
			...
			Date date = calendar.getTime();
			DateFormat df = new SimpleDateFormat(FORMAT_STRING_MINUTE1);
			String format = df.format(date); 
		    return format;
		}
		 ...
		 *    将年月格式化成年
		 *<b>Author:</b> yanwei
		 *<b>Date:</b> 2021年8月22日 上午11:58:06
		 *@param strDate
		 *@param format
		 *@return
		 *@throws ParseException
		 *</pre>
		 */
		public static String getDateStringToString(String strDate,String format){
			String str="";
			try {
				 SimpleDateFormat sdf = new SimpleDateFormat (FORMAT_STRING_MINUTE1);
				 Date date =  sdf.parse(strDate);
				 SimpleDateFormat sdf1 = new SimpleDateFormat(format);
				 str=sdf1.format(date);
			} catch (Exception e) {
