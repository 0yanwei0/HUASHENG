...
public class ExcelToImage {
	...
	public static void generatePic(XSSFWorkbook wb, String imagesName) throws Exception {
...
//		XSSFWorkbook workbook = new XSSFWorkbook(inputStream);
		...
		imageHeight = imageHeight * 96 / 72+40;
		imageWidth = imageWidth * 115 / 100+40;
		...
		g2d.dispose();
		ImageIO.write(image, "jpg", new File("/root/images/"+imagesName));
	...
	public static List<List<String>> readXlsx(XSSFWorkbook wb, int pageNum) throws Exception {
...
//		String path = "C:/Users/Administrator/Desktop/aaa.xls";
//		test(path);
//	}
