...
public class SapZjxshkTb {
    ...
    private String cwkhkm;

    private String fwfkm;

    private String sapjxsbm;
    ...
    public void setDdje(String ddje) {
        this.ddje = ddje == null ? null : ddje.trim();
    }
    ...
    public void setXxs(String xxs) {
        this.xxs = xxs == null ? null : xxs.trim();
    }

    public String getCwkhkm() {
        return cwkhkm;
    }

    public void setCwkhkm(String cwkhkm) {
        this.cwkhkm = cwkhkm == null ? null : cwkhkm.trim();
    }

    public String getFwfkm() {
        return fwfkm;
    }

    public void setFwfkm(String fwfkm) {
        this.fwfkm = fwfkm == null ? null : fwfkm.trim();
    }

    public String getSapjxsbm() {
        return sapjxsbm;
    }

    public void setSapjxsbm(String sapjxsbm) {
        this.sapjxsbm = sapjxsbm == null ? null : sapjxsbm.trim();
    }
    ...
    public void setSkly(String skly) {
        this.skly = skly == null ? null : skly.trim();
    }
}