...
<!--                 	<li iconCls="icon-application-view-columns"><a href="javascript:void(0)" data-icon="icon-application-view-columns" data-link="sap-overdueproduction-list" iframe="0">生产入库明细</a></li> -->
            ...
            <div title="运营跟单提成管理" data-options="iconCls:'icon-application-cascade'" style="padding:5px;">  	
    			<ul class="easyui-tree wu-side-tree">
					  <li iconCls="icon-application-form-edit"><a href="javascript:void(0)" data-icon="icon-application-form-edit" data-link="xxdddjys-list" iframe="0">订单主数据管理</a></li>
					  <li iconCls="icon-application-view-columns"><a href="javascript:void(0)" data-icon="icon-application-view-columns" data-link="yyddtc-list" iframe="0">运营提成查看</a></li>
					  <li iconCls="icon-application-view-columns"><a href="javascript:void(0)" data-icon="icon-application-view-columns" data-link="gdtc-list" iframe="0">跟单提成查看</a></li>
                </ul>
            </div>
        </div>
    </div>	
...
<!-- 								<a href="#" class="easyui-linkbutton" iconCls="icon-cancel" onclick="closeMesQrcodeExcel()">取消</a> -->
								<label>实际下达日期 : </label><input id="sjxdrq" class="easyui-datebox" style="width: 150px">
	...
	/*  $(function(){
		...
		*/	
		...
		function addMesQrcodeTb(){
			var sjxdrq=$('#sjxdrq').datebox('getValue');
			$.ajax({  
				 type: 'GET',  
			     dataType : 'json', 
			     data: {sjxdrq:sjxdrq},
